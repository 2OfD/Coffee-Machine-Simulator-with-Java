...
public enum CoffeeMachineState {
    ...
    CHOOSING_BUYING_OPTIONS(true, "What do you want to buy? 1 - espresso, 2 - latte, 3 - cappucino, back - to main menu:") {
        @Override
        public CoffeeMachineState next(CoffeeMachine coffeeMachine) {
    ...
    FILLING_WATER(true, "Write how many ml of water you want to add:") {
        @Override
        public CoffeeMachineState next(CoffeeMachine coffeeMachine) {
    ...
    FILLING_COFFEE_BEANS(true, "Write how many grams of coffee beans you want to add:") {
        @Override
        public CoffeeMachineState next(CoffeeMachine coffeeMachine) {
    ...
    FILLING_CUPS(true, "Write how many disposable cups you want to add:") {
        @Override
        public CoffeeMachineState next(CoffeeMachine coffeeMachine) {
